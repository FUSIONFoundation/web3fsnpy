...
web3fsnpy User Guide 
====================

web3fsnpy is a python library for interacting with Fusion.  Its API is derived
from the `Web3.py`_  and `Web3.js`_ Javascript API and should be familiar to anyone who has
used ``web3.py`` which it extends. It mirrors Fusion's `web3-fusion-extend`_ Javascript library in its functionality.
...
.. _web3-fusion-extend: https://github.com/FUSIONFoundation/web3-fusion-extend
